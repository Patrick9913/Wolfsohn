        ...
        <main className=" h-screen w-screen flex justify-center items-center">
            <div className=" rounded-xl flex flex-col gap-y-4 justify-center items-center h-screen w-screen lg:h-[650px] lg:w-[1200px] bg-black shadow-lg shadow-gray-600 bg-opacity-65">
                ...
                <div className=" flex flex-col justify-center items-center gap-y-7">
                    ...
                    <button className=" text-stone-50 px-6 py-3 border border-white rounded-md font-semibold hover:bg-slate-600 hover:text-orange-200 ease-in duration-150">Iniciar Sesión</button>
